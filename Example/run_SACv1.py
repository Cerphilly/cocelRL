...
def hyperparameters():
    ...
    parser.add_argument('--env-name', default='cartpole/swingup', help='Pendulum-v0, MountainCarContinuous-v0, cartpole_swingup')
...
def main(args):
    ...
    algorithm = SAC_v1(state_dim, action_dim, device, args)
